                                        ...
                                        <fieldset width="100%" >
                                            ...
                                            <table width="100%" cellpadding="5" cellspacing="5" align="center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" name="telephone" id="telephone" class="texttype" onkeyup="contact(this)" value="<%=tno%>">
                                                    </td>
                                                    <td class="text-1">
                                                        Mobile No.
                                                    </td>
                                                    <td>
                                                        <input type="text" name="mobile" id="mobile" class="texttype" onkeyup="contact(this)"  value="<%=mno%>">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="text-1">
