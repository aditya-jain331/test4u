                                                ...
                                                <form method="post" action="login">
                                                    <table width="100%" cellpadding="5" cellspacing="5" align="center">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select name="cmbtype" id="cmbtype" class="combotext" style="width:225px;">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" name="name" id="name"  class="texttype" size="30">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="text">
                                                            ...
                                                            <td>
                                                                <input type="password" name="password" id="password" size="30" class="texttype">
                                                            </td>
                                                        </tr>
